    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bulking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent =new Intent(Eating.this,com.example.finalx.Bulking.class);
        ...
        Proteins.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent(Eating.this,com.example.finalx.Proteins.class);
                startActivity(intent);
            }
        });
        ...
        Carbs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent(Eating.this,com.example.finalx.Carbs.class);
                startActivity(intent);
            }
        });
        ...
        Fats.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent(Eating.this,com.example.finalx.Fats.class);
                startActivity(intent);
            }
        });
    }
   ...
   @Override
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.exercises) {
            ...
            Intent intent = new Intent(Eating.this, com.example.finalx.Exercises.class);
            startActivity(intent);

        } else if (id == R.id.Info) {
            Intent intent = new Intent(Eating.this, com.example.finalx.Info.class);
            startActivity(intent);

        } else if (id == R.id.Eating) {

            Intent intent = new Intent(Eating.this, com.example.finalx.Eating.class);
            startActivity(intent);

        } else if (id == R.id.Calculators) {

            Intent intent = new Intent(Eating.this, com.example.finalx.CalculatorCalories.class);
            startActivity(intent);
