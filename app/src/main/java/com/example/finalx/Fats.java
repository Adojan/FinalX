...
public class Fats extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.fats, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.exercises) {
            ...
            Intent intent = new Intent(Fats.this, com.example.finalx.Exercises.class);
            startActivity(intent);

        } else if (id == R.id.Info) {
            Intent intent = new Intent(Fats.this, com.example.finalx.Info.class);
            startActivity(intent);

        } else if (id == R.id.Eating) {

            Intent intent = new Intent(Fats.this, com.example.finalx.Eating.class);
            startActivity(intent);

        } else if (id == R.id.Calculators) {

            Intent intent = new Intent(Fats.this, com.example.finalx.CalculatorCalories.class);
            startActivity(intent);
