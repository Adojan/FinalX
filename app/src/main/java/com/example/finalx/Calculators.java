...
public class Calculators extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Calories.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent =new Intent(Calculators.this,com.example.finalx.CalculatorCalories.class);
        ...
        XXX.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent(Calculators.this,com.example.finalx.CalculatorXXX.class);
                startActivity(intent);
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.exercises) {
            ...
            Intent intent = new Intent(Calculators.this, com.example.finalx.Exercises.class);
            startActivity(intent);

        } else if (id == R.id.Info) {
            Intent intent = new Intent(Calculators.this, com.example.finalx.Info.class);
            startActivity(intent);

        } else if (id == R.id.Eating) {

            Intent intent = new Intent(Calculators.this, com.example.finalx.Eating.class);
            startActivity(intent);
